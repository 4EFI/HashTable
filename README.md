...
"strcmp" все еще вносит значительный вклад в функцию поиска и, так как ассемблерной вставкой ускорить ничего не получилось, давайте воспользуемся векторными инструкциями
