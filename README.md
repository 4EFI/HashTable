...
> Также важное замечание, наши данные должны быть выравнены по 32-байтной границе, для этого нам необходима выделять память с помощью функции [aligned_alloc](https://en.cppreference.com/w/c/memory/aligned_alloc), которая выравнивает память при выделении по нужной границе. 
